...
PROVIDERS: Dict[str, dict] = {
    "zhipu": {"name":"智谱(GLM)","base_url":"https://open.bigmodel.cn/api/paas/v4/",
        ...
        "default_model":"glm-4-flash","models":["glm-4-flash","glm-4-plus","glm-4.5","glm-5-turbo","glm-5.1","glm-4v","glm-4v-plus"],
    ...
    "openai": {"name":"OpenAI(GPT)","base_url":"https://api.openai.com/v1/",
        ...
        "default_model":"gpt-4o-mini","vision_models":["gpt-4o","gpt-4o-vision","gpt-4-vision-preview"],"models":["gpt-4o-mini","gpt-4o","gpt-5","o4-mini","gpt-4o-vision","gpt-4-vision-preview"],
    ...
    "openclaw": {"name":"OpenRouter","base_url":"https://openrouter.ai/v1/",
        "env_keys":["OPENCLAW_API_KEY"],
        "default_model":"gpt-4o","models":["gpt-4o","claude-3-opus","gemini-2.0-flash","llama-3-70b"],
        "auth_mode":"bearer","guide_url":"https://openclaw.ai","pricing":"pay-as-you-go","tier":3,
        "description":"Multi-model gateway, OpenAI protocol"},
    "deepseek": {"name":"DeepSeek","base_url":"https://api.deepseek.com/v1/",
        "env_keys":["DEEPSEEK_API_KEY","OPENAI_COMPATIBLE_API_KEY"],
        "default_model":"deepseek-reasoner","chat_model":"deepseek-chat",
        "models":["deepseek-reasoner","deepseek-chat","deepseek-coder-v2","deepseek-v4-pro"],
        "auth_mode":"bearer","guide_url":"https://platform.deepseek.com/api_keys","pricing":"送500万tokens","tier":1,
        "description":"最强推理大模型，R1深度思考，自主操盘核心引擎"},
    ...
    "ollama": {"name":"Ollama(本地)","base_url":"http://localhost:11434/v1/",
        "env_keys":[],"default_model":"qwen2.5:0.5b",
        "models":["qwen2.5-coder:7b","qwen2.5:0.5b","llava:7b","qwen2.5:7b","qwen2.5:14b","llama3.1:8b","deepseek-r1:7b"],
