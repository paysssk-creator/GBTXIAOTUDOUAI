...
- **[MEDIUM]** desktop\app.py:590 — 硬编码IP
- **[MEDIUM]** desktop\app.py:162 — return后死代码
- **[MEDIUM]** desktop\app.py:564 — return后死代码
- **[MEDIUM]** desktop\app.py:750 — return后死代码
- **[MEDIUM]** desktop\app.py:775 — return后死代码
- **[MEDIUM]** desktop\app.py:818 — return后死代码
- **[MEDIUM]** desktop\app.py:843 — return后死代码
- **[MEDIUM]** desktop\app.py:852 — return后死代码
- **[MEDIUM]** desktop\app.py:863 — return后死代码
- **[MEDIUM]** desktop\app.py:877 — return后死代码
- **[MEDIUM]** desktop\app.py:890 — return后死代码
- **[MEDIUM]** desktop\app.py:893 — return后死代码
- **[MEDIUM]** gbt\account.py:41 — return后死代码
- **[MEDIUM]** gbt\agent.py:55 — return后死代码
- **[MEDIUM]** gbt\agent.py:58 — return后死代码
- **[MEDIUM]** gbt\brain.py:56 — return后死代码
...
- **[MEDIUM]** gbt\trader.py:400 — return后死代码
- **[MEDIUM]** gbt\trader.py:577 — return后死代码
- **[MEDIUM]** gbt\trader.py:695 — return后死代码
- **[MEDIUM]** gbt\watcher.py:165 — 硬编码IP
- **[MEDIUM]** gbt\watcher.py:453 — 硬编码IP
