...
- **[MEDIUM]** desktop\app.py:591 — 硬编码IP
- **[MEDIUM]** desktop\app.py:163 — return后死代码
- **[MEDIUM]** desktop\app.py:565 — return后死代码
- **[MEDIUM]** desktop\app.py:751 — return后死代码
- **[MEDIUM]** desktop\app.py:776 — return后死代码
- **[MEDIUM]** desktop\app.py:819 — return后死代码
- **[MEDIUM]** desktop\app.py:844 — return后死代码
- **[MEDIUM]** desktop\app.py:853 — return后死代码
- **[MEDIUM]** desktop\app.py:864 — return后死代码
- **[MEDIUM]** desktop\app.py:878 — return后死代码
- **[MEDIUM]** desktop\app.py:891 — return后死代码
- **[MEDIUM]** desktop\app.py:894 — return后死代码
- **[MEDIUM]** gbt\account.py:42 — return后死代码
- **[MEDIUM]** gbt\agent.py:55 — return后死代码
- **[MEDIUM]** gbt\agent.py:58 — return后死代码
- **[MEDIUM]** gbt\brain.py:64 — return后死代码
...
- **[MEDIUM]** gbt\trader.py:429 — return后死代码
- **[MEDIUM]** gbt\trader.py:606 — return后死代码
- **[MEDIUM]** gbt\trader.py:724 — return后死代码
