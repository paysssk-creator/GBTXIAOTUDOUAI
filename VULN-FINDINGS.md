...
- **[MEDIUM]** desktop\app.py:559 — 硬编码IP
- **[MEDIUM]** desktop\app.py:131 — return后死代码
- **[MEDIUM]** desktop\app.py:533 — return后死代码
- **[MEDIUM]** desktop\app.py:697 — return后死代码
- **[MEDIUM]** desktop\app.py:722 — return后死代码
- **[MEDIUM]** desktop\app.py:765 — return后死代码
- **[MEDIUM]** desktop\app.py:790 — return后死代码
- **[MEDIUM]** desktop\app.py:799 — return后死代码
- **[MEDIUM]** desktop\app.py:810 — return后死代码
- **[MEDIUM]** desktop\app.py:824 — return后死代码
- **[MEDIUM]** desktop\app.py:837 — return后死代码
- **[MEDIUM]** desktop\app.py:840 — return后死代码
...
- **[MEDIUM]** gbt\trader.py:382 — return后死代码
- **[MEDIUM]** gbt\trader.py:559 — return后死代码
- **[MEDIUM]** gbt\trader.py:663 — return后死代码
- **[MEDIUM]** gbt\watcher.py:145 — 硬编码IP
- **[MEDIUM]** gbt\watcher.py:386 — 硬编码IP
- **[MEDIUM]** start_demo.py:17 — return后死代码
- **[MEDIUM]** tools\mcp_tools.py:15 — return后死代码
- **[LOW]** desktop\app.py:70 — console残留
