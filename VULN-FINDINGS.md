...
- **[MEDIUM]** desktop\app.py:549 — 硬编码IP
- **[MEDIUM]** desktop\app.py:121 — return后死代码
- **[MEDIUM]** desktop\app.py:523 — return后死代码
...
- **[LOW]** desktop\app.py:66 — console残留
