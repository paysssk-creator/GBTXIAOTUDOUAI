...
1. Download the whole delivery package.
2. Extract it to any local folder.
3. Double-click `GBT_Pro_User_Setup.bat`.
4. Wait for the desktop shortcut `GBT Pro.lnk` to appear.
5. Double-click the desktop shortcut to start the app.
